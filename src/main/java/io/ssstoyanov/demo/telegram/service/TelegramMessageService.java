package io.ssstoyanov.demo.telegram.service;
...
public class TelegramMessageService extends TelegramService {
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).PHOTO")
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).VIDEO")
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).AUDIO")
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).PHOTO_SERIES")
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).VIDEO_SERIES")
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).TEXT")
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).PHOTO_VIDEO_SERIES")
    ...
    @EventListener(value = ParsedContentEvent.class,
            condition = "!(#event.object.type == T(io.ssstoyanov.demo.media.entity.ContentType).ERROR)")
